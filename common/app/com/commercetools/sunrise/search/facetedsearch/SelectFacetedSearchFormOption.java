...
public final class SelectFacetedSearchFormOption extends FormOption<List<SortExpression<ProductProjection>>> {

    private SelectFacetedSearchFormOption(final String fieldLabel, final String fieldValue, final List<SortExpression<ProductProjection>> expressions, final boolean isDefault) {
    ...
    public static SelectFacetedSearchFormOption of(final String fieldLabel, final String fieldValue, final List<SortExpression<ProductProjection>> expressions, final boolean isDefault) {
        return new SelectFacetedSearchFormOption(fieldLabel, fieldValue, expressions, isDefault);
    }
}
