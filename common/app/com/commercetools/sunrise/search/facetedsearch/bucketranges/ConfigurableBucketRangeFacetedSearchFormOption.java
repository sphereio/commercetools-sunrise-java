...
public class ConfigurableBucketRangeFacetedSearchFormOption extends BucketRangeFacetedSearchFormOptionImpl {
    ...
    public ConfigurableBucketRangeFacetedSearchFormOption(final Configuration configuration) {
