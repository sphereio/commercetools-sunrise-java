...
final class ConfigurableTermFacetedSearchFormSettings<T> extends ConfigurableMultiOptionFacetedSearchFormSettings<T> implements TermFacetedSearchFormSettings<T> {
