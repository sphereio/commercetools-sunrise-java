...
import com.commercetools.sunrise.search.facetedsearch.old.FacetSelectorViewModel;
import com.commercetools.sunrise.search.facetedsearch.old.FacetedSearchSelector;
import com.commercetools.sunrise.search.facetedsearch.old.FacetedSearchSelectorListFactory;
...
public final class AbstractFacetedSearchControllerComponent implements ControllerComponent, PageDataReadyHook, ProductProjectionSearchHook, ProductProjectionPagedSearchResultLoadedHook, CategoryLoadedHook {
    ...
    @Inject
    public AbstractFacetedSearchControllerComponent(final I18nIdentifierResolver i18nIdentifierResolver, final FacetedSearchSelectorListFactory facetedSearchSelectorListFactory) {
