...
public class ConfigurableSortFormSettings extends SortFormSettingsImpl {

    private static final String CONFIG_KEY = "key";
    private static final String DEFAULT_KEY = "sort";
    private static final String CONFIG_OPTIONS = "options";

    ConfigurableSortFormSettings(final String fieldName, final List<SortFormOption> options) {
