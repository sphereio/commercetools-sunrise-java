...
@RequestScoped
public class CustomerInSession extends AssociatedDataResourceStateWriter<Customer> {
    ...
    @Inject
    public CustomerInSession(final ObjectHttpSessionStrategy session, final Configuration configuration) {
    ...
    @Override
    protected void overwriteAssociatedDataInSession(final Customer customer) {
