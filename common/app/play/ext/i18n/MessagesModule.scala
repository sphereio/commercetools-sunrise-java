...
//  protected val fileNames: Seq[String] = config.get[Seq[String]]("play.i18n.files")
  ...
  private def filterHashArgsEntries(args: Seq[Any]): Seq[Entry[String, Any]] = {
  ...
  private def findAppliedKey(key: String, args: Seq[Entry[String, Any]]): String = {
  ...
  private def replaceParameters(pattern: String, args: Seq[Entry[String, Any]]): String = {
