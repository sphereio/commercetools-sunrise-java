...
public class CategoriesWithProductCountQueryIntegrationTest {

    @Test
    public void isExecuted() throws Exception {
        try (final BlockingSphereClient sphereClient = provideSphereClient()) {
            withProductAssignedToOneCategory(sphereClient, categoryIds -> {
    ...
    private void withProductAssignedToOneCategory(final BlockingSphereClient sphereClient, final Consumer<List<String>> test) {
