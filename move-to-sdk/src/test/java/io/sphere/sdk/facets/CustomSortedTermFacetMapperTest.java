...
import static io.sphere.sdk.facets.CustomSortedTermFacetMapper.comparePositions;
...
public class CustomSortedTermFacetMapperTest {
    ...
    public void sortsOptionsAsGivenList() throws Exception {
        final List<FacetOption> sortedFacetOptions = CustomSortedTermFacetMapper.of(asList("A", "B", "C"))
    ...
    public void onEmptyListKeepsSameOrder() throws Exception {
        final List<FacetOption> sortedFacetOptions = CustomSortedTermFacetMapper.of(emptyList())
                .apply(asList(OPTION_B, OPTION_D, OPTION_A, OPTION_C, OPTION_E));
